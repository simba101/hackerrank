/*
Solution to the "BotCleanStochastic" challenge by HackerRank:
...
/**
 * Note that this code is IDENTICAL to the answer submitted for the problem
 * "BotClean" (https://www.hackerrank.com/challenges/botclean)
 * as it simply works. Never mind that there will never be more than one dirt
 * spot at a time, this solution works flawlessly for any number of spots put
