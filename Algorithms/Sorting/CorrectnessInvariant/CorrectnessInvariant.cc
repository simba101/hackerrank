...
// Note: This problem may be answered by submitting the solution
// to the "InsertionSort2" challenge. So this is the exact copy :-)
...
int main(int argc, char **argv)
{
  ...
  // prints out the state of the array at the end of insertionsort:
  print_array();
